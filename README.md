...
- [$name](https://crates.io/crates/chimera-nano-kernel)
- [$name](https://crates.io/crates/chimera-crypto-quantum)
- [$name](https://crates.io/crates/chimera-transport-quic)
- [$name](https://crates.io/crates/chimera-dht-routing)

### Execution

- [$name](https://crates.io/crates/chimera-wasm-runtime)
- [$name](https://crates.io/crates/chimera-memory-fabric)
- [$name](https://crates.io/crates/chimera-storage-cas)
- [$name](https://crates.io/crates/chimera-fuser-mount)
- [$name](https://crates.io/crates/chimera-consensus-dag)
- [$name](https://crates.io/crates/chimera-network-bridge)
- [$name](https://crates.io/crates/chimera-compiler-jit)

### Intelligence

- [$name](https://crates.io/crates/chimera-nexus)
- [$name](https://crates.io/crates/chimera-agent-swarm)
- [$name](https://crates.io/crates/chimera-inference-engine)
- [$name](https://crates.io/crates/chimera-telemetry-otel)

### Security

- [$name](https://crates.io/crates/chimera-rbac-auth)
- [$name](https://crates.io/crates/chimera-compliance-tee)
- [$name](https://crates.io/crates/chimera-policy-engine)
- [$name](https://crates.io/crates/chimera-audit-ledger)

### Tooling

- [$name](https://crates.io/crates/chimeractl)
- [$name](https://crates.io/crates/chimera-boot)
- [$name](https://crates.io/crates/chimera-usb-daemon)

### Umbrella

- [$name](https://crates.io/crates/chimera-mesh)

Regenerated by `scripts/sync-crates-readme.ps1` (markers `<!-- CRATES-IO-START -->` / `<!-- CRATES-IO-END -->`).
<!-- CRATES-IO-END -->
